...
#
#   p1_pruned_ema_reconstructed  {off, on}   (sliced adapter)   = 64x3x2 = 384
#   p1_recovered                 {off, on}   (sliced adapter)   = 64x3x2 = 384
#                                                             total = 768 new WAVs
#
...
for BACKBONE in p1_pruned_ema_reconstructed p1_recovered; do
