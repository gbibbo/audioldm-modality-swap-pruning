%% ICASSP manuscript (Draft 15) on the official ICASSP 2027 template.
%% Reader-first revision incorporating the third methodological review.
%% Figures are intentionally NOT generated in this draft. The boxes reserve the intended final
%% footprint, and detailed figure-generation specifications appear as TeX comments in draft15_2.tex.
%% draft15-third-review
