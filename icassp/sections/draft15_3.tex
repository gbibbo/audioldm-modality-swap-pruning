...
Human-CLAP, KL to matched real references and PANNs top-10 capture all show a larger recovery at longer durations. The published DDIM $200$, guidance $3.5$ recipe reproduces the endpoint interaction with $J=+0.184$ \ci{+0.126}{+0.243}, and the registered severity~2 conclusions survive Holm correction. These checks reuse the AudioCaps prompt draw, so they establish metric and sampler robustness rather than an independent prompt replication.
...
The weight convention does not explain this result. On the same prompts, dense raw and EMA baselines differ by $+0.001$ \ci{-0.017}{+0.020} at $3.84$\,s and $-0.017$ \ci{-0.044}{+0.010} at $10.24$\,s. The two $20{,}000$-step dense fine-tunes nevertheless degrade strongly relative to the raw start, with all four duration-by-training gains between $-0.220$ and $-0.168$ and every upper $95\%$ bound below $-0.144$. Their training-duration contrast remains unresolved, $\Delta J_{\rm dense}=-0.005$ \ci{-0.033}{+0.025}. Thus the same short recipe that improves the pruned checkpoint moves an already AudioCaps-trained dense model sharply downward, while still providing no evidence of training-duration specialization.
...
Severity~1 shows genuine prompt-set heterogeneity. The original outcome-blind $80$-prompt draw gives $J=+0.044$ \ci{-0.000}{+0.088}, whereas a disjoint $96$-prompt draw gives $+0.169$ \ci{+0.115}{+0.222}; their difference is $+0.124$ \ci{+0.058}{+0.194}. Severity~2 is markedly more stable under the same diagnostic. Splitting its outcome-blind $192$-prompt draw into two halves gives $J=+0.159$ \ci{+0.116}{+0.200} and $+0.160$ \ci{+0.122}{+0.198}, with a difference of $+0.001$ \ci{-0.056}{+0.057}. Clotho supplies an additional independent prompt set on which the interaction also resolves.
