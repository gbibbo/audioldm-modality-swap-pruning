...
\label{tab:core}
\setlength{\tabcolsep}{1.9pt}\renewcommand{\arraystretch}{1.0}
\scriptsize
\begin{tabular}{@{}lcclc@{}}
\toprule
...
\label{tab:anchors}
\setlength{\tabcolsep}{1.4pt}\renewcommand{\arraystretch}{1.0}
\scriptsize
\begin{tabular}{@{}lcccc@{}}
\toprule
...
$\ci{-0.024}{+0.020}$ (Fig.~\ref{fig:ops}d). Second, a post-hoc crop analysis scores the first $3.84$\,s of each $10.24$\,s generation under the same
