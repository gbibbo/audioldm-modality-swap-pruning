...
The final two-panel figure is generated from the committed per-prompt artifacts by `scripts/research/paper_figs/make_draft16_fig1.py`, at the footprint the LaTeX source reserved, so the page layout is unchanged. The plotting specification stays in the LaTeX source as comments.
