...
The ICASSP manuscript is designed to stand on its own. It contains the scientific question, experimental design, central effect sizes, robustness table, main limitations and intended figure footprint. This companion is the audit and reproduction layer.

## Paper files

* [`icassp/icassp_operating_point.tex`](icassp/icassp_operating_point.tex), canonical Draft 14 source
* [`icassp/sections/draft14_1.tex`](icassp/sections/draft14_1.tex) through [`icassp/sections/draft14_4.tex`](icassp/sections/draft14_4.tex), modular source
