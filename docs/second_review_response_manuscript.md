...
The manuscript now uses the matched 20,000-step train@3.84 versus train@10.24 intervention as the direct specialization test. The key contrast is Delta J = -0.035 [-0.064,-0.004]. The abstract no longer says that the earlier one-arm test alone contradicted specialization. The current claim is limited to the matched short-budget intervention.
